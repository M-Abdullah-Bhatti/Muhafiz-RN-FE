...
import { StyleSheet, SafeAreaView, View, Text, Image, TouchableOpacity , Button ,TextInput } from 'react-native';
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <TouchableOpacity onPress={navigateToMapWithButtons}>
        ...
        >
          ...
          <Text style={styles.middleText}>Plot No.PS-1 Khyaban-e-Razwan Phase No.7 Ext DHA Main Korangi Road Karachi.</Text>
        ...
        <TouchableOpacity onPress={navigateToCrimeReportScreen}>
          <View style={styles.customView}>
            ...
            <Text style={styles.customViewText}>
              Report incidents happening around you to the nearest police stations or prescient close to you. Remember, the police is here to help you.
            </Text>
            <Image
      ...
      <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.actionButton} onPress={navigateToCreateAPost}>
            <Text style={styles.buttonText}>Create A Post</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton} onPress={navigateToCimeTracking}>
