  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={[styles.button, styles.flexButton]} onPress={pickMedia}>
          ...
          <Text style={styles.buttonText}>Attach Media</Text>
            ...
            <TouchableOpacity style={[styles.button, styles.flexButton]} onPress={pinLocation}>
      ...
      <SubmitButton text="Submit" onPress={addPost} buttonColor={color.orange} />
